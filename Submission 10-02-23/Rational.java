...
public class Rational {
    ...
    public Rational add(Rational other) {
        ...
        long num = this.x * other.y + other.x * this.y;
        long denom = this.y * other.y;
    ...
    public boolean equals(Object other) {
        ...
        // Can't use other of Rational, so we need to declare it.
        Rational differ = (Rational) other;
        // Rationals a/b and c/d are equal iff a == c and b == d.
        return this.x == differ.x && this.y == differ.y;
    }
